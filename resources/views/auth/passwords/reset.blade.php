                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="w-lg-500px p-10 p-lg-15 mx-auto full-height">
                                <!--begin::Form-->
                                <form method="POST" action="{{ route('password.update') }}" class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="#">
                                    @csrf
                                    <!--begin::Heading-->
                                    <input type="hidden" name="token" value="{{ $token }}">
                                    ...
                                    <div class="fv-row mb-5">
                                        <!--begin::Label-->
                                        <label class="form-label fs-6 fw-bolder text-dark"><h2>Reset Password</h2></label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input class="form-control form-control-lg form-control-solid @error('email') is-invalid @enderror" style="padding: 16px 25px;background-color: #FBFBFB;border-color: #CDCDCD" type="text" name="email" autocomplete="off" placeholder="Email" value="{{ $email ?? old('email') }}"/>
                                    ...
                                    <!--begin::Input group-->
                                    <div class="fv-row mb-5">
                                        <input style="padding: 16px 25px; background-color: #FBFBFB;border-color: #CDCDCD" class="form-control form-control-lg form-control-solid @error('password') is-invalid @enderror" type="password" name="password" autocomplete="current-password" placeholder="Password" />
                                        @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="fv-row mb-10">
                                        <input style="padding: 16px 25px; background-color: #FBFBFB;border-color: #CDCDCD" class="form-control form-control-lg form-control-solid @error('password') is-invalid @enderror" type="password" placeholder="{{ __('Confirm Password') }}" id="password-confirm" name="password_confirmation" required autocomplete="new-password"/>
                                        @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>

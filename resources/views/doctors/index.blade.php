			...
			<div class="card-header border-0 pt-6">
				...
				<div class="card-title">
					...
					<div class="d-flex align-items-center position-relative my-1">
						...
						<!--end::Svg Icon-->
						<input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Doctor" />
					</div>
					<!--end::Search-->
				</div>
				<!--begin::Card title-->
						...
						<tr>
                            ...
                            <td class="text-end">
                                <form  method="POST" action="{{ route('doctors.destroy', $doctor->id) }}">
                                    @csrf
                                    <a href="{{route('doctors.edit', $doctor->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
